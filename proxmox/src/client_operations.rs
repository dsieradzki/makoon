...
impl ClientOperations {
    ...
    pub fn storage(&self, node: &str, storage_content_type: Option<StorageContentType>) -> Result<Vec<Storage>> {
        debug!("Get storage");
    ...
    pub fn storage_content_details(&self, node: &str, storage: &str, volid: &str) -> Result<StorageContentDetails> {
        Ok(
