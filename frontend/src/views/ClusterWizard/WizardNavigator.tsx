            ...
            {(value: WizardNavigationContextType) =>
                <div className="flex justify-between pt-10">
                    <div className="flex">
                        ...
                        <Block
                            onClick={() => {
                                if (isGenerating || clusterStore.provisioningInProgress) {
                                    return
                                }
                                navigate("/list")
                            }}
                            ...
                            <div
                                className={`flex items-center justify-start p-2 ${isGenerating || clusterStore.provisioningInProgress ? "text-stone-600" : "danger"}`}>
