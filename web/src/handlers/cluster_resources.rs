...
use actix_web::{delete, http::header::ContentType, post, put, web, HttpResponse, Responder};
...
pub async fn save_cluster_resources(
    path: web::Path<String>,
    body: web::Json<core::model::ClusterResource>,
    session: Session,
...
pub async fn update_cluster_resources(
    path: web::Path<String>,
    body: web::Json<core::model::ClusterResource>,
    session: Session,
    proxmox_client: inject::ProxmoxClient,
...
pub async fn delete_cluster_resources(
...
pub async fn install_cluster_resources(
    path: web::Path<(String, String)>,
    session: Session,
    proxmox_client: inject::ProxmoxClient,
    operator: inject::Operator,
...
pub async fn uninstall_cluster_resources(
    path: web::Path<(String, String)>,
    session: Session,
    proxmox_client: inject::ProxmoxClient,
    operator: inject::Operator,
